@ST_114995 @tagtagtag @this_is_story_tag
...
@SC_490828 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490829 @third_scenario_tag
...
@SC_490830 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490831 @fifth_scenario_tag
