@ST_115516 @tagtagtag @this_is_story_tag
...
@SC_492877 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492878 @third_scenario_tag
...
@SC_492879 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492880 @fifth_scenario_tag
