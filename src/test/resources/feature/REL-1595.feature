@ST_84015 @tagtagtag @this_is_story_tag
...
@SC_369995 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369996 @third_scenario_tag
...
@SC_369997 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369998 @fifth_scenario_tag
