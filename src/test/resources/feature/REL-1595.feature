@ST_101405 @tagtagtag @this_is_story_tag
...
@SC_439030 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_439031 @third_scenario_tag
...
@SC_439032 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_439033 @fifth_scenario_tag
