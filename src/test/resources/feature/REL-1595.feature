@ST_104524 @tagtagtag @this_is_story_tag
...
@SC_451269 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451270 @third_scenario_tag
...
@SC_451271 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451272 @fifth_scenario_tag
