@ST_93786 @tagtagtag @this_is_story_tag
...
@SC_409942 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409943 @third_scenario_tag
...
@SC_409944 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409945 @fifth_scenario_tag
