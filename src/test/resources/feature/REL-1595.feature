@ST_39783 @tagtagtag @this_is_story_tag
...
@SC_197014 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_197015 @third_scenario_tag
...
@SC_197016 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_197017 @fifth_scenario_tag
