@ST_66406 @tagtagtag @this_is_story_tag
...
@SC_301143 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301144 @third_scenario_tag
...
@SC_301145 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_301146 @fifth_scenario_tag
