@ST_90660 @tagtagtag @this_is_story_tag
...
@SC_397648 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397649 @third_scenario_tag
...
@SC_397650 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397651 @fifth_scenario_tag
