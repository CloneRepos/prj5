@ST_78326 @tagtagtag @this_is_story_tag
...
@SC_347920 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347921 @third_scenario_tag
...
@SC_347922 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347923 @fifth_scenario_tag
