@ST_48849 @tagtagtag @this_is_story_tag
...
@SC_233294 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233295 @third_scenario_tag
...
@SC_233296 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233297 @fifth_scenario_tag
