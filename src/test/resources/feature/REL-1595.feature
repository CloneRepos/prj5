@ST_70143 @tagtagtag @this_is_story_tag
...
@SC_316846 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316847 @third_scenario_tag
...
@SC_316848 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316849 @fifth_scenario_tag
