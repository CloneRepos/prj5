@ST_86210 @tagtagtag @this_is_story_tag
...
@SC_379222 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_379223 @third_scenario_tag
...
@SC_379224 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_379225 @fifth_scenario_tag
