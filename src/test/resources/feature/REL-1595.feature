@ST_104003 @tagtagtag @this_is_story_tag
...
@SC_449220 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_449221 @third_scenario_tag
...
@SC_449222 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_449223 @fifth_scenario_tag
