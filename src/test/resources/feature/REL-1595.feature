@ST_6257 @tagtagtag @this_is_story_tag
...
@SC_40679 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_40680 @third_scenario_tag
...
@SC_40681 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_40682 @fifth_scenario_tag
