@ST_105566 @tagtagtag @this_is_story_tag
...
@SC_455367 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_455368 @third_scenario_tag
...
@SC_455369 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_455370 @fifth_scenario_tag
