@ST_38427 @tagtagtag @this_is_story_tag
...
@SC_189926 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189927 @third_scenario_tag
...
@SC_189928 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189929 @fifth_scenario_tag
