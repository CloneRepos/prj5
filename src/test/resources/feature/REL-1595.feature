@ST_35725 @tagtagtag @this_is_story_tag
...
@SC_181109 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_181110 @third_scenario_tag
...
@SC_181111 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_181112 @fifth_scenario_tag
