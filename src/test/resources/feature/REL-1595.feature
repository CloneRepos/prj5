@ST_106847 @tagtagtag @this_is_story_tag
...
@SC_459147 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_459148 @third_scenario_tag
...
@SC_459149 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_459150 @fifth_scenario_tag
