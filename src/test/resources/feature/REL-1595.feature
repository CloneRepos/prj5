@ST_88590 @tagtagtag @this_is_story_tag
...
@SC_389575 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389576 @third_scenario_tag
...
@SC_389577 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389578 @fifth_scenario_tag
