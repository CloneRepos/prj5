@ST_92223 @tagtagtag @this_is_story_tag
...
@SC_403795 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403796 @third_scenario_tag
...
@SC_403797 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403798 @fifth_scenario_tag
