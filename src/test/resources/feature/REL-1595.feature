@ST_97238 @tagtagtag @this_is_story_tag
...
@SC_422651 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422652 @third_scenario_tag
...
@SC_422653 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422654 @fifth_scenario_tag
