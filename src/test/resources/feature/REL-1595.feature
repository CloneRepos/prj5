@ST_46682 @tagtagtag @this_is_story_tag
...
@SC_225618 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225619 @third_scenario_tag
...
@SC_225620 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225621 @fifth_scenario_tag
