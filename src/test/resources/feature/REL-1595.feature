@ST_81087 @tagtagtag @this_is_story_tag
...
@SC_358184 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_358185 @third_scenario_tag
...
@SC_358186 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_358187 @fifth_scenario_tag
