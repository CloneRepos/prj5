@ST_61122 @tagtagtag @this_is_story_tag
...
@SC_281038 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_281039 @third_scenario_tag
...
@SC_281040 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_281041 @fifth_scenario_tag
