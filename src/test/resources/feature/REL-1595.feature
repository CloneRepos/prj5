@ST_11186 @tagtagtag @this_is_story_tag
...
@SC_73262 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73263 @third_scenario_tag
...
@SC_73264 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73265 @fifth_scenario_tag
