@ST_120724 @tagtagtag @this_is_story_tag
...
@SC_513365 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513366 @third_scenario_tag
...
@SC_513367 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_513368 @fifth_scenario_tag
