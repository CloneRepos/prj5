@ST_34516 @tagtagtag @this_is_story_tag
...
@SC_177397 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177398 @third_scenario_tag
...
@SC_177399 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177400 @fifth_scenario_tag
