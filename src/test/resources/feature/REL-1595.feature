@ST_111442 @tagtagtag @this_is_story_tag
...
@SC_476799 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476800 @third_scenario_tag
...
@SC_476801 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476802 @fifth_scenario_tag
