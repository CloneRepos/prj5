@ST_116037 @tagtagtag @this_is_story_tag
...
@SC_494926 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_494927 @third_scenario_tag
...
@SC_494928 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_494929 @fifth_scenario_tag
