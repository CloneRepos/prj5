@ST_62142 @tagtagtag @this_is_story_tag
...
@SC_284322 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284323 @third_scenario_tag
...
@SC_284324 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284325 @fifth_scenario_tag
