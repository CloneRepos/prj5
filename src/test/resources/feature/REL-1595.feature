@ST_94213 @tagtagtag @this_is_story_tag
...
@SC_411202 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411203 @third_scenario_tag
...
@SC_411204 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_411205 @fifth_scenario_tag
