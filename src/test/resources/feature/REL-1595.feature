@ST_63195 @tagtagtag @this_is_story_tag
...
@SC_288388 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288389 @third_scenario_tag
...
@SC_288390 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288391 @fifth_scenario_tag
