@ST_125816 @tagtagtag @this_is_story_tag
...
@SC_532883 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532884 @third_scenario_tag
...
@SC_532885 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532886 @fifth_scenario_tag
