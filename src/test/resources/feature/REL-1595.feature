@ST_123322 @tagtagtag @this_is_story_tag
...
@SC_523554 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523555 @third_scenario_tag
...
@SC_523556 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523557 @fifth_scenario_tag
