@ST_81636 @tagtagtag @this_is_story_tag
...
@SC_360500 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360501 @third_scenario_tag
...
@SC_360502 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_360503 @fifth_scenario_tag
