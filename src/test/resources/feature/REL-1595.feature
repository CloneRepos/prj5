@ST_95682 @tagtagtag @this_is_story_tag
...
@SC_416560 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416561 @third_scenario_tag
...
@SC_416562 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416563 @fifth_scenario_tag
