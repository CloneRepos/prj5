@ST_79019 @tagtagtag @this_is_story_tag
...
@SC_350741 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350742 @third_scenario_tag
...
@SC_350743 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350744 @fifth_scenario_tag
