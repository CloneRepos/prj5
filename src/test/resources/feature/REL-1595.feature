@ST_107368 @tagtagtag @this_is_story_tag
...
@SC_461196 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461197 @third_scenario_tag
...
@SC_461198 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_461199 @fifth_scenario_tag
