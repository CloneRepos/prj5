@ST_45977 @tagtagtag @this_is_story_tag
...
@SC_222820 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222821 @third_scenario_tag
...
@SC_222822 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222823 @fifth_scenario_tag
