@ST_119682 @tagtagtag @this_is_story_tag
...
@SC_509267 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509268 @third_scenario_tag
...
@SC_509269 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_509270 @fifth_scenario_tag
