@ST_94734 @tagtagtag @this_is_story_tag
...
@SC_413251 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413252 @third_scenario_tag
...
@SC_413253 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_413254 @fifth_scenario_tag
