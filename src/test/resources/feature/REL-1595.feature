@ST_64301 @tagtagtag @this_is_story_tag
...
@SC_291847 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291848 @third_scenario_tag
...
@SC_291849 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291850 @fifth_scenario_tag
