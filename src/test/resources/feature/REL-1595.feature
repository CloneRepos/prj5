@ST_67130 @tagtagtag @this_is_story_tag
...
@SC_304272 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304273 @third_scenario_tag
...
@SC_304274 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304275 @fifth_scenario_tag
