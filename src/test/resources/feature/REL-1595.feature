@ST_124364 @tagtagtag @this_is_story_tag
...
@SC_527652 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527653 @third_scenario_tag
...
@SC_527654 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527655 @fifth_scenario_tag
