@ST_118641 @tagtagtag @this_is_story_tag
...
@SC_505170 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505171 @third_scenario_tag
...
@SC_505172 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_505173 @fifth_scenario_tag
