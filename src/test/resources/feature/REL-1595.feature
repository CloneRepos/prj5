@ST_99843 @tagtagtag @this_is_story_tag
...
@SC_432896 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432897 @third_scenario_tag
...
@SC_432898 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432899 @fifth_scenario_tag
