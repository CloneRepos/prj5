@ST_29575 @tagtagtag @this_is_story_tag
...
@SC_155883 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155884 @third_scenario_tag
...
@SC_155885 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155886 @fifth_scenario_tag
