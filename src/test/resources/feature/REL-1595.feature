@ST_110921 @tagtagtag @this_is_story_tag
...
@SC_474750 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474751 @third_scenario_tag
...
@SC_474752 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474753 @fifth_scenario_tag
