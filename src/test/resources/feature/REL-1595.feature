@ST_112390 @tagtagtag @this_is_story_tag
...
@SC_480583 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480584 @third_scenario_tag
...
@SC_480585 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_480586 @fifth_scenario_tag
