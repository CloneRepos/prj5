@ST_72098 @tagtagtag @this_is_story_tag
...
@SC_324043 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_324044 @third_scenario_tag
...
@SC_324045 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_324046 @fifth_scenario_tag
