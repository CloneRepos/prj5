@ST_118120 @tagtagtag @this_is_story_tag
...
@SC_503121 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_503122 @third_scenario_tag
...
@SC_503123 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_503124 @fifth_scenario_tag
