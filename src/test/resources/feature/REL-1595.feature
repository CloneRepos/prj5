@ST_53036 @tagtagtag @this_is_story_tag
...
@SC_251276 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251277 @third_scenario_tag
...
@SC_251278 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251279 @fifth_scenario_tag
