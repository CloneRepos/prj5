@ST_8970 @tagtagtag @this_is_story_tag
...
@SC_61460 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61461 @third_scenario_tag
...
@SC_61462 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61463 @fifth_scenario_tag
