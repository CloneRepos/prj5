@ST_113432 @tagtagtag @this_is_story_tag
...
@SC_484681 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484682 @third_scenario_tag
...
@SC_484683 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484684 @fifth_scenario_tag
