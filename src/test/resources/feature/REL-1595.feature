@ST_33668 @tagtagtag @this_is_story_tag
...
@SC_174142 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174143 @third_scenario_tag
...
@SC_174144 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_174145 @fifth_scenario_tag
