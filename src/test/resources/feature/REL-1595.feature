@ST_61392 @tagtagtag @this_is_story_tag
...
@SC_282612 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282613 @third_scenario_tag
...
@SC_282614 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282615 @fifth_scenario_tag
