@ST_56941 @tagtagtag @this_is_story_tag
...
@SC_265547 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265548 @third_scenario_tag
...
@SC_265549 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265550 @fifth_scenario_tag
