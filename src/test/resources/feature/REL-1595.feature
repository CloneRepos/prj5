@ST_97759 @tagtagtag @this_is_story_tag
...
@SC_424700 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424701 @third_scenario_tag
...
@SC_424702 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424703 @fifth_scenario_tag
