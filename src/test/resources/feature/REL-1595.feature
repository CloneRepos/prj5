@ST_45403 @tagtagtag @this_is_story_tag
...
@SC_220275 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220276 @third_scenario_tag
...
@SC_220277 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220278 @fifth_scenario_tag
