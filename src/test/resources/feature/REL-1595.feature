@ST_77809 @tagtagtag @this_is_story_tag
...
@SC_345835 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345836 @third_scenario_tag
...
@SC_345837 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_345838 @fifth_scenario_tag
