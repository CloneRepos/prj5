@ST_11840 @tagtagtag @this_is_story_tag
...
@SC_78370 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78371 @third_scenario_tag
...
@SC_78372 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78373 @fifth_scenario_tag
