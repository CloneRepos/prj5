@ST_71670 @tagtagtag @this_is_story_tag
...
@SC_322778 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322779 @third_scenario_tag
...
@SC_322780 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322781 @fifth_scenario_tag
