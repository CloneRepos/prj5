@ST_110400 @tagtagtag @this_is_story_tag
...
@SC_472701 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472702 @third_scenario_tag
...
@SC_472703 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_472704 @fifth_scenario_tag
