@ST_61712 @tagtagtag @this_is_story_tag
...
@SC_282924 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282925 @third_scenario_tag
...
@SC_282926 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282927 @fifth_scenario_tag
