@ST_28753 @tagtagtag @this_is_story_tag
...
@SC_152118 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_152119 @third_scenario_tag
...
@SC_152120 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_152121 @fifth_scenario_tag
