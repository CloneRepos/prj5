@ST_92744 @tagtagtag @this_is_story_tag
...
@SC_405844 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405845 @third_scenario_tag
...
@SC_405846 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405847 @fifth_scenario_tag
