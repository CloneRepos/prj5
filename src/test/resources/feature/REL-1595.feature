@ST_63874 @tagtagtag @this_is_story_tag
...
@SC_290587 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290588 @third_scenario_tag
...
@SC_290589 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290590 @fifth_scenario_tag
