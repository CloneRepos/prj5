@ST_49799 @tagtagtag @this_is_story_tag
...
@SC_236659 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236660 @third_scenario_tag
...
@SC_236661 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236662 @fifth_scenario_tag
