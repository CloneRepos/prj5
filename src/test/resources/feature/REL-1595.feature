@ST_117599 @tagtagtag @this_is_story_tag
...
@SC_501072 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_501073 @third_scenario_tag
...
@SC_501074 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_501075 @fifth_scenario_tag
