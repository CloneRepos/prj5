@ST_103482 @tagtagtag @this_is_story_tag
...
@SC_447171 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_447172 @third_scenario_tag
...
@SC_447173 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_447174 @fifth_scenario_tag
