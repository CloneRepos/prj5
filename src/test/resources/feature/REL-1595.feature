@ST_123843 @tagtagtag @this_is_story_tag
...
@SC_525603 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525604 @third_scenario_tag
...
@SC_525605 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525606 @fifth_scenario_tag
