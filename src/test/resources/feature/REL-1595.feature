@ST_107889 @tagtagtag @this_is_story_tag
...
@SC_463245 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_463246 @third_scenario_tag
...
@SC_463247 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_463248 @fifth_scenario_tag
