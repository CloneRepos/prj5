@ST_121245 @tagtagtag @this_is_story_tag
...
@SC_515414 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515415 @third_scenario_tag
...
@SC_515416 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_515417 @fifth_scenario_tag
