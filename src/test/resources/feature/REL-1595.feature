@ST_91702 @tagtagtag @this_is_story_tag
...
@SC_401746 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401747 @third_scenario_tag
...
@SC_401748 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401749 @fifth_scenario_tag
