@ST_15096 @tagtagtag @this_is_story_tag
...
@SC_97210 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97211 @third_scenario_tag
...
@SC_97212 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_97213 @fifth_scenario_tag
