@ST_12957 @tagtagtag @this_is_story_tag
...
@SC_82679 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82680 @third_scenario_tag
...
@SC_82681 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82682 @fifth_scenario_tag
