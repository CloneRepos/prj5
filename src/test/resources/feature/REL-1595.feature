@ST_122801 @tagtagtag @this_is_story_tag
...
@SC_521505 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521506 @third_scenario_tag
...
@SC_521507 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_521508 @fifth_scenario_tag
