@ST_40230 @tagtagtag @this_is_story_tag
...
@SC_198483 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198484 @third_scenario_tag
...
@SC_198485 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198486 @fifth_scenario_tag
