@ST_74327 @tagtagtag @this_is_story_tag
...
@SC_332769 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332770 @third_scenario_tag
...
@SC_332771 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332772 @fifth_scenario_tag
