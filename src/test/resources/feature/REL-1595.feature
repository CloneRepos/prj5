@ST_47277 @tagtagtag @this_is_story_tag
...
@SC_227508 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227509 @third_scenario_tag
...
@SC_227510 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227511 @fifth_scenario_tag
