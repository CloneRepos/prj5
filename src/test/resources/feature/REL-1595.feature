@ST_79441 @tagtagtag @this_is_story_tag
...
@SC_352003 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_352004 @third_scenario_tag
...
@SC_352005 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_352006 @fifth_scenario_tag
