@ST_109452 @tagtagtag @this_is_story_tag
...
@SC_469392 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469393 @third_scenario_tag
...
@SC_469394 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469395 @fifth_scenario_tag
