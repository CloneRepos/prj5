@ST_100885 @tagtagtag @this_is_story_tag
...
@SC_436994 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436995 @third_scenario_tag
...
@SC_436996 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436997 @fifth_scenario_tag
