@ST_51653 @tagtagtag @this_is_story_tag
...
@SC_244834 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244835 @third_scenario_tag
...
@SC_244836 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244837 @fifth_scenario_tag
