@ST_57858 @tagtagtag @this_is_story_tag
...
@SC_268762 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268763 @third_scenario_tag
...
@SC_268764 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268765 @fifth_scenario_tag
