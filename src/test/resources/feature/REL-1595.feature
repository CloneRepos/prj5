@ST_119161 @tagtagtag @this_is_story_tag
...
@SC_507218 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507219 @third_scenario_tag
...
@SC_507220 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_507221 @fifth_scenario_tag
