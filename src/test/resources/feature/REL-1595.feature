@ST_124791 @tagtagtag @this_is_story_tag
...
@SC_528912 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528913 @third_scenario_tag
...
@SC_528914 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528915 @fifth_scenario_tag
