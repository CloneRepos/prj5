@ST_108410 @tagtagtag @this_is_story_tag
...
@SC_465294 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465295 @third_scenario_tag
...
@SC_465296 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465297 @fifth_scenario_tag
