@ST_65550 @tagtagtag @this_is_story_tag
...
@SC_297230 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297231 @third_scenario_tag
...
@SC_297232 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_297233 @fifth_scenario_tag
