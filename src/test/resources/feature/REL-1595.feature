@ST_52299 @tagtagtag @this_is_story_tag
...
@SC_247968 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247969 @third_scenario_tag
...
@SC_247970 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247971 @fifth_scenario_tag
