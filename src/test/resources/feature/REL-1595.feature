@ST_125305 @tagtagtag @this_is_story_tag
...
@SC_530905 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530906 @third_scenario_tag
...
@SC_530907 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530908 @fifth_scenario_tag
