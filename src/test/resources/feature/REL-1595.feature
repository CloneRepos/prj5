@ST_35303 @tagtagtag @this_is_story_tag
...
@SC_179847 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179848 @third_scenario_tag
...
@SC_179849 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179850 @fifth_scenario_tag
