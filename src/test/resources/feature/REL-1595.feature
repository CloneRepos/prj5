@ST_36584 @tagtagtag @this_is_story_tag
...
@SC_183633 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183634 @third_scenario_tag
...
@SC_183635 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183636 @fifth_scenario_tag
