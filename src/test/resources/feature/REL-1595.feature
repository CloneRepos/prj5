@ST_44818 @tagtagtag @this_is_story_tag
...
@SC_217678 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217679 @third_scenario_tag
...
@SC_217680 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217681 @fifth_scenario_tag
