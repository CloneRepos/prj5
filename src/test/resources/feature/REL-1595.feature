@ST_44207 @tagtagtag @this_is_story_tag
...
@SC_214732 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214733 @third_scenario_tag
...
@SC_214734 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214735 @fifth_scenario_tag
