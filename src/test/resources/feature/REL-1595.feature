@ST_77382 @tagtagtag @this_is_story_tag
...
@SC_344571 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344572 @third_scenario_tag
...
@SC_344573 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344574 @fifth_scenario_tag
