@ST_105993 @tagtagtag @this_is_story_tag
...
@SC_456627 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_456628 @third_scenario_tag
...
@SC_456629 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_456630 @fifth_scenario_tag
