@ST_87950 @tagtagtag @this_is_story_tag
...
@SC_386470 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386471 @third_scenario_tag
...
@SC_386472 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386473 @fifth_scenario_tag
