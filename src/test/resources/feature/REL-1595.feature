@ST_72626 @tagtagtag @this_is_story_tag
...
@SC_326148 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326149 @third_scenario_tag
...
@SC_326150 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_326151 @fifth_scenario_tag
