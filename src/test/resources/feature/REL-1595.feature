@ST_56704 @tagtagtag @this_is_story_tag
...
@SC_264668 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264669 @third_scenario_tag
...
@SC_264670 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264671 @fifth_scenario_tag
