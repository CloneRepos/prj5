@ST_76684 @tagtagtag @this_is_story_tag
...
@SC_341785 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341786 @third_scenario_tag
...
@SC_341787 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341788 @fifth_scenario_tag
