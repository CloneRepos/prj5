@ST_47704 @tagtagtag @this_is_story_tag
...
@SC_228767 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228768 @third_scenario_tag
...
@SC_228769 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228770 @fifth_scenario_tag
