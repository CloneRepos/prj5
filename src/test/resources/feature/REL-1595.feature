@ST_12617 @tagtagtag @this_is_story_tag
...
@SC_81731 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81732 @third_scenario_tag
...
@SC_81733 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81734 @fifth_scenario_tag
