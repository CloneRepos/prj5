@ST_86730 @tagtagtag @this_is_story_tag
...
@SC_381270 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381271 @third_scenario_tag
...
@SC_381272 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381273 @fifth_scenario_tag
