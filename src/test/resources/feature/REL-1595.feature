@ST_7433 @tagtagtag @this_is_story_tag
...
@SC_49602 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_49603 @third_scenario_tag
...
@SC_49604 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_49605 @fifth_scenario_tag
