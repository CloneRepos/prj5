@ST_32217 @tagtagtag @this_is_story_tag
...
@SC_168974 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168975 @third_scenario_tag
...
@SC_168976 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168977 @fifth_scenario_tag
