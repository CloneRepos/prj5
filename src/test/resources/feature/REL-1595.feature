@ST_100364 @tagtagtag @this_is_story_tag
...
@SC_434945 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434946 @third_scenario_tag
...
@SC_434947 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434948 @fifth_scenario_tag
