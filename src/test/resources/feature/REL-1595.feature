@ST_80559 @tagtagtag @this_is_story_tag
...
@SC_356037 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_356038 @third_scenario_tag
...
@SC_356039 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_356040 @fifth_scenario_tag
