@ST_106420 @tagtagtag @this_is_story_tag
...
@SC_457887 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457888 @third_scenario_tag
...
@SC_457889 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457890 @fifth_scenario_tag
