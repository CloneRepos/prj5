@ST_111874 @tagtagtag @this_is_story_tag
...
@SC_478534 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478535 @third_scenario_tag
...
@SC_478536 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478537 @fifth_scenario_tag
