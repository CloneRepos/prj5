@ST_113953 @tagtagtag @this_is_story_tag
...
@SC_486730 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486731 @third_scenario_tag
...
@SC_486732 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486733 @fifth_scenario_tag
