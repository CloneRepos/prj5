@ST_73341 @tagtagtag @this_is_story_tag
...
@SC_329092 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_329093 @third_scenario_tag
...
@SC_329094 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_329095 @fifth_scenario_tag
