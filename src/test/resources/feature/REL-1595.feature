@ST_89104 @tagtagtag @this_is_story_tag
...
@SC_391569 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391570 @third_scenario_tag
...
@SC_391571 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391572 @fifth_scenario_tag
