@ST_69299 @tagtagtag @this_is_story_tag
...
@SC_312978 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312979 @third_scenario_tag
...
@SC_312980 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312981 @fifth_scenario_tag
