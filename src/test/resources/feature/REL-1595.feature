@ST_114474 @tagtagtag @this_is_story_tag
...
@SC_488779 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488780 @third_scenario_tag
...
@SC_488781 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488782 @fifth_scenario_tag
