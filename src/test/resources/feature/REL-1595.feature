@ST_82685 @tagtagtag @this_is_story_tag
...
@SC_364654 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364655 @third_scenario_tag
...
@SC_364656 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364657 @fifth_scenario_tag
