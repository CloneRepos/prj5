@ST_75045 @tagtagtag @this_is_story_tag
...
@SC_335753 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335754 @third_scenario_tag
...
@SC_335755 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335756 @fifth_scenario_tag
