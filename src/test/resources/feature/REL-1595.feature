@ST_120203 @tagtagtag @this_is_story_tag
...
@SC_511316 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511317 @third_scenario_tag
...
@SC_511318 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511319 @fifth_scenario_tag
