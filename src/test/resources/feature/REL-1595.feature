@ST_59099 @tagtagtag @this_is_story_tag
...
@SC_273829 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273830 @third_scenario_tag
...
@SC_273831 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273832 @fifth_scenario_tag
