@ST_96196 @tagtagtag @this_is_story_tag
...
@SC_418553 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418554 @third_scenario_tag
...
@SC_418555 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418556 @fifth_scenario_tag
