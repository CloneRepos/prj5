@ST_57436 @tagtagtag @this_is_story_tag
...
@SC_267503 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267504 @third_scenario_tag
...
@SC_267505 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267506 @fifth_scenario_tag
