@ST_37428 @tagtagtag @this_is_story_tag
...
@SC_186155 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186156 @third_scenario_tag
...
@SC_186157 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_186158 @fifth_scenario_tag
