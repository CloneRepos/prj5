@ST_43657 @tagtagtag @this_is_story_tag
...
@SC_212555 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212556 @third_scenario_tag
...
@SC_212557 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212558 @fifth_scenario_tag
