@ST_50478 @tagtagtag @this_is_story_tag
...
@SC_238859 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238860 @third_scenario_tag
...
@SC_238861 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238862 @fifth_scenario_tag
