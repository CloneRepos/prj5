@ST_108931 @tagtagtag @this_is_story_tag
...
@SC_467343 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467344 @third_scenario_tag
...
@SC_467345 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467346 @fifth_scenario_tag
