@ST_37006 @tagtagtag @this_is_story_tag
...
@SC_184895 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184896 @third_scenario_tag
...
@SC_184897 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184898 @fifth_scenario_tag
