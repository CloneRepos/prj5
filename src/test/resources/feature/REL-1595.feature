@ST_96717 @tagtagtag @this_is_story_tag
...
@SC_420602 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420603 @third_scenario_tag
...
@SC_420604 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420605 @fifth_scenario_tag
