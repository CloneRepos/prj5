@ST_64897 @tagtagtag @this_is_story_tag
...
@SC_293791 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293792 @third_scenario_tag
...
@SC_293793 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293794 @fifth_scenario_tag
