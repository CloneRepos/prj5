@ST_41174 @tagtagtag @this_is_story_tag
...
@SC_202119 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_202120 @third_scenario_tag
...
@SC_202121 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_202122 @fifth_scenario_tag
