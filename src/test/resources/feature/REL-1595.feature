@ST_42437 @tagtagtag @this_is_story_tag
...
@SC_207592 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207593 @third_scenario_tag
...
@SC_207594 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207595 @fifth_scenario_tag
