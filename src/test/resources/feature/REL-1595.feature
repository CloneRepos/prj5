@ST_98801 @tagtagtag @this_is_story_tag
...
@SC_428798 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428799 @third_scenario_tag
...
@SC_428800 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_428801 @fifth_scenario_tag
