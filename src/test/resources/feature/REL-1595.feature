@ST_85689 @tagtagtag @this_is_story_tag
...
@SC_377173 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_377174 @third_scenario_tag
...
@SC_377175 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_377176 @fifth_scenario_tag
