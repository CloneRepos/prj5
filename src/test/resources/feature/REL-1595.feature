@ST_87251 @tagtagtag @this_is_story_tag
...
@SC_383319 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_383320 @third_scenario_tag
...
@SC_383321 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_383322 @fifth_scenario_tag
