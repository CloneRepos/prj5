@ST_73769 @tagtagtag @this_is_story_tag
...
@SC_330352 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330353 @third_scenario_tag
...
@SC_330354 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_330355 @fifth_scenario_tag
