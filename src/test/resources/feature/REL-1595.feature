@ST_34959 @tagtagtag @this_is_story_tag
...
@SC_178846 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178847 @third_scenario_tag
...
@SC_178848 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178849 @fifth_scenario_tag
