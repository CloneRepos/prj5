@ST_56351 @tagtagtag @this_is_story_tag
...
@SC_264024 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264025 @third_scenario_tag
...
@SC_264026 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264027 @fifth_scenario_tag
