@ST_93265 @tagtagtag @this_is_story_tag
...
@SC_407893 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407894 @third_scenario_tag
...
@SC_407895 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_407896 @fifth_scenario_tag
