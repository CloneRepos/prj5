@ST_105045 @tagtagtag @this_is_story_tag
...
@SC_453318 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_453319 @third_scenario_tag
...
@SC_453320 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_453321 @fifth_scenario_tag
